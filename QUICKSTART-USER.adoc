...
// Replace im-docs, Im Docs — See README.adoc for details., just run, Im Docs started successfully. with actuals
= im-docs — Quick Start for Users
:toc:
:toclevels: 2

== What is im-docs?

Im Docs — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./im-docs-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/im-docs/wiki
