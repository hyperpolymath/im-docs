...
// Replace im-docs, im-docs, {{DEPS}} with actuals
= im-docs — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining im-docs for
...
[source,bash]
----
git clone https://github.com/hyperpolymath/im-docs.git
cd im-docs
just build-release
----
...
| `$PREFIX/share/im-docs/`
| Data files, assets

| `$PREFIX/share/doc/im-docs/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/im-docs/config.toml`

Fallback: `$HOME/.config/im-docs/config.toml`
...
Or via OPSM: `opsm update im-docs`
...
[source,bash]
----
just install --prefix=/opt/im-docs-instance1 --config=/etc/im-docs/instance1.toml
just install --prefix=/opt/im-docs-instance2 --config=/etc/im-docs/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/im-docs/issues
